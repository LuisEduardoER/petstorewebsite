...
--
-- Temporary table structure for view `petstore`.`customer_ratio`
--
DROP TABLE IF EXISTS `petstore`.`customer_ratio`;
DROP VIEW IF EXISTS `petstore`.`customer_ratio`;
CREATE TABLE `petstore`.`customer_ratio` (
  `category` varchar(45),
  `quantity` bigint(21)
);
...
INSERT INTO `petstore`.`customer_dim` VALUES  (1,'Security',0),
 (2,'Manufacture',0),
 (3,'Medical',0),
 (4,'home',1),
 (5,'home',1),
...
INSERT INTO `petstore`.`customerbus` VALUES  (1,'McCoy Corporation','Mccoy corporation is a private business','Security','1234789.29'),
 (2,'Vick Inc','Vick Inc provides companies with animal food','Manufacture','99999999.99'),
 (3,'Tim Heating Company','They need food for their guard dogs','Medical','56321126.87'),
 (6,'UPMCAD','University of Pittsburgh Medicial Center Animal Department','Health','99999999.99'),
 (7,'Animal Shelter','animals care','Health','6738298.76'),
 (8,'Pet Beauty Salon','pet salon','Service','877655.47'),
 (9,'Kimco Security','security guards provider','Security','334427.89');
UNLOCK TABLES;
...
INSERT INTO `petstore`.`customers` VALUES  (1,'1234 centre ave.','Pittsburgh','PA','15232',0,NULL,NULL,NULL),
 ...
 (7,'8 Boilermaker Way','West Lafayette','IN','47906',0,'Orton','Kyle',NULL),
 (8,'897 oakland ave.','New York city','NJ','27889',0,'Mike','Morgan',NULL),
 (9,'234 Frobes ave.','seattle','WA','23129',0,'Sara',NULL,NULL);
UNLOCK TABLES;
...
INSERT INTO `petstore`.`factsale` VALUES  (3,1,8,312,'11.00'),
 (3,1,8,313,'12.89'),
 (3,1,8,314,'1.09'),
 (3,1,14,98,'55.98'),
 (3,2,8,312,'11.00'),
...
INSERT INTO `petstore`.`orders` VALUES  (1,1,1,1,'2008-09-10','1050.00'),
 ...
 (58,1,4,9,'2009-07-16','16.00'),
 (59,2,4,7,'2009-07-16','32.00'),
 (60,2,4,6,'2009-07-18','64.00');
UNLOCK TABLES;
...
INSERT INTO `petstore`.`time_dim` VALUES  (1,'2009-01-01 00:00:00',1,1,1),
 ...
 (88,'2009-03-31 00:00:00',13,88,0),
...
--
-- Definition of view `petstore`.`customer_ratio`
--

DROP TABLE IF EXISTS `petstore`.`customer_ratio`;
DROP VIEW IF EXISTS `petstore`.`customer_ratio`;
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `petstore`.`customer_ratio` AS (select 'business' AS `category`,count(0) AS `quantity` from `petstore`.`customer_dim` `cd1` where (`cd1`.`customertype` = 0)) union (select `cd1`.`category` AS `category`,count(0) AS `count(*)` from `petstore`.`customer_dim` `cd1` where (`cd1`.`customertype` = 1));
