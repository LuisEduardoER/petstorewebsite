            ...
            <a href="#"><img src="images/de.gif" alt="" title="" border="0" /></a>
              ...
              <div class="login">
				...
				<form name="login" action="login.jsp" method="POST">
					...
					<div class="username">UserName: <input type="text" name="username" value="" size="20" /><br></div>
					<div class="password">Password: <input type="password" name="password" value="" size="20" /><br></div>
					<div class="submit"><input type="submit" value="Login" name="login" />
				</form>
